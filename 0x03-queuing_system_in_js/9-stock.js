...
/**
 * Modifies tha reserved stock for a given item.
 * @param {number} itemId - Tha id of tha item.
 * @param {number} stock - Tha stock of tha item.
 */
...
/**
 * Retrieves tha reserved stock for tha given item.
 * @param {number} itemId - Tha id of  item.
